...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 11, 2021 at 06:47 PM
...
(27, ' shadman', '  dong', '2021-09-21', ' Male', 1789674348, ' Dinanaee', '  nakuyy', 'shelapaali@gmail.com'),
...
(3, 0, 'fsfsfsfsf', '0003-03-31 ', 'Male', 2147483647, 2147483647, 0, ' dgdg@ff.com', 'sfsfsfsf sfsfsfsfsfs fsfsfsfs sfsfsfsfs fsfs sfsfs fsfs fsfsf sfsfsf sfsfsfs');
...
(1, 'sadadad', 0, ' afafafafaf', 'afaf@h.coms', 'sgsgs', 'sgsgsg', 242424, '4645644646564'),
(2, 'sadadad', 2147483647, ' afafafafaf', 'afaf@h.coms', 'Sedan', '2242424242', 242424, '4645644646564');
...
--
ALTER TABLE `booking`
  MODIFY `BookID` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;

--
-- AUTO_INCREMENT for table `customer`
--
ALTER TABLE `customer`
  MODIFY `CustomerID` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
...
--
ALTER TABLE `payment`
  MODIFY `PaymentSlipNumber` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
