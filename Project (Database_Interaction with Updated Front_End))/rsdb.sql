...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 13, 2021 at 12:49 PM
...
--
ALTER TABLE `booking`
  MODIFY `BookID` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;

--
-- AUTO_INCREMENT for table `customer`
--
ALTER TABLE `customer`
  MODIFY `CustomerID` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;

--
-- AUTO_INCREMENT for table `feedback`
--
ALTER TABLE `feedback`
  MODIFY `Feed_Back_No` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `payment`
  MODIFY `PaymentSlipNumber` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
