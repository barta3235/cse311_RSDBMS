...
<head>
    ...
    <h1 class="hone">Welcome Admin  <?php echo $_SESSION['Name']; ?></h1><br><br><br>
      ...
      <table>
          ...
          <tbody>
            <?php
                 include('./connection.php');     
                 $trip="select BookID, CustomerID, FirstName, MobileNumber, VehicleID, VehicleType, Driverphone, Date, StartLocation, StartTime, EndLocation, VehicleFare
                           from booking order by BookID";
 ...
 <h2 class= "hmid">Income From Customers</h2><br>
...
<table>
    ...
    <th>Customer ID</th>
    <th>Customer Number</th>
    <th>Total Income From Each Customer</th>
    </thead>

    <tbody>
      <?php
           include('./connection.php');     
           $trip="select count(BookID), CustomerID, MobileNumber, SUM(VehicleFare)
                     from booking group by CustomerID, MobileNumber order by CustomerID";
           $queryt= mysqli_query($conn ,$trip);
           while($rowt= mysqli_fetch_array($queryt)){
               $t1= $rowt[0];
               $t2= $rowt[1];
...
<h2 class= "hmid">Feed Back</h2><br>
 <table>
    ...
    <tbody>
      <?php
           include('./connection.php');     
           $trip="select Feed_Back_No, Name, MobileNumber, Email, Message
                     from feedback order by Feed_Back_No";
           $queryt= mysqli_query($conn ,$trip);
           while($rowt= mysqli_fetch_array($queryt)){
               $t1= $rowt[0];
               $t2= $rowt[1];
...
<h2 class= "hmid2">Application Form (Vehicles)</h2><br>
...
<table>
    ...
    <tbody>
      <?php
           include('./connection.php');     
           $trip="select ID, OwnerName, MobileNumber, Address, Email, VehicleType, ModelName, ModelYear, RegistrationNumber
                     from rentcar order by ID";
           $queryt= mysqli_query($conn ,$trip);
           while($rowt= mysqli_fetch_array($queryt)){
               $t1= $rowt[0];
               $t2= $rowt[1];
          ...
          <tr>
              ...
              <td> <?php echo $t8 ?>  </td>
              <td> <?php echo $t9 ?>  </td>
              <td> <a href="./deleterentVEH.php?id= <?php echo $t1 ?>">Delete</a>
 ...
 <h2 class= "hmid2">Application Form (Driver)</h2><br>
...
<table>
    ...
    <tbody>
      <?php
           include('./connection.php');     
           $trip="select ID, FirstName, LastName, Birthdate, Gender, MobileNumber, NID, LicenseNumber, Email,	Experience
                     from hiredriver order by ID";
           $queryt= mysqli_query($conn ,$trip);
           while($rowt= mysqli_fetch_array($queryt)){
               $t1= $rowt[0];
               $t2= $rowt[1];
          ...
          <tr>
              ...
              <td> <?php echo $t9 ?>  </td>
              <td> <?php echo $t10 ?>  </td>
              <td> <a href="./deletehireDRIv.php?id= <?php echo $t1 ?>">Delete</a>
